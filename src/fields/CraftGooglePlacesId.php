 ...
 * @since     1.0.0
 */
class CraftGooglePlacesId extends Field
{
  // Public Properties
  // =========================================================================
  /**
  ...
  {
    return Craft::t('craft-google-places', 'CraftGooglePlacesId');
  }
  ...
  public function getSettingsHtml()
  {
    ...
    return Craft::$app->getView()->renderTemplate(
      'craft-google-places/_components/fields/CraftGooglePlacesId_settings',
      [
        'field' => $this,
      ]
    );
  ...
  public function getInputHtml($value, ElementInterface $element = null): string
  {
    ...
    Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CraftGooglePlacesCraftGooglePlacesId(" . $jsonVars . ");");

    // Render the input template
    return Craft::$app->getView()->renderTemplate(
      'craft-google-places/_components/fields/CraftGooglePlacesId_input',
      [
        'name' => $this->handle,
        'value' => $value,
        'field' => $this,
